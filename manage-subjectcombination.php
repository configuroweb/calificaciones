...
<?php if($stts=='0')
{ ?>
<a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('Realmente deseas activar esta materia');"><i class="fa fa-check" title="Acticvate Record"></i> </a><?php } else {?>
