                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Sistema Administrativo de Asistencia</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<p><b>ID de estudiante :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Año Escolar :</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
