...
$query->execute();
$msg="Los datos fueron actualizados exitósamente";
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Actualizar Año Escolar</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Editar Años de Clase</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Actualizar Año de Clase</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Editar Información de Años de Clase</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
