                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Rellena la información del estudiante</h5>
                                                </div>
                                            </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">ID Matrícula</label>
<div class="col-sm-10">
...
{
?>
<input type="radio" name="gender" value="Masculino" required="required" checked>Masculino <input type="radio" name="gender" value="Femenino" required="required">Femenino <input type="radio" name="gender" value="Otro" required="required">Otro
<?php }?>
<?php  
if($gndr=="Femenino")
{
?>
<input type="radio" name="gender" value="Masculino" required="required" >Masculino <input type="radio" name="gender" value="Femenino" required="required" checked>Femenino <input type="radio" name="gender" value="Otro" required="required">Otro
<?php }?>
<?php  
if($gndr=="Otro")
{
?>
<input type="radio" name="gender" value="Masculino" required="required" >Masculino <input type="radio" name="gender" value="Femenino" required="required">Femenino <input type="radio" name="gender" value="Otro" required="required" checked>Otro
<?php }?>
