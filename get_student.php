...
if(!empty($_POST["classid1"])) 
{
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {?>
  <p> <?php echo htmlentities($row['SubjectName']); ?><input type="text"  name="marks[]" value="" class="form-control" required="" placeholder="Ingrese calificación sobre 100" autocomplete="off"></p>
...
<p>
<?php
echo "<span style='color:red'> Resultados de estudiante ya declarado</span>";
