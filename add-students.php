...
if($lastInsertId)
{
$msg="Estudiante Ingresado Exitósamente";
}
else 
{
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Agregar Estudiantes</h2>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Diligencia la información de estudiante</h5>
                                                </div>
                                            </div>
...
<div class="col-sm-10">
<input type="radio" name="gender" value="Male" required="required" checked="">Hombre <input type="radio" name="gender" value="Female" required="required">Mujer <input type="radio" name="gender" value="Other" required="required">Otro
</div>
</div>
